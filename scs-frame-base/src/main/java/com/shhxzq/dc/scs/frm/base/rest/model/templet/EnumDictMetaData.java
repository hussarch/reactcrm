 ...
 */
public class EnumDictMetaData extends BaseMetaData{
	
	private String key;
	private String value;

	public EnumDictMetaData(String key, String value){
	    this.key = key;
	    this.value = value;
	}
	
	public EnumDictMetaData(DictData dict){
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        EnumDictMetaData other = (EnumDictMetaData) obj;
        if (key == null) {
            if (other.key != null)
                return false;
